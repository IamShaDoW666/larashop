      ...
      <FrontEnd :restaurant="restaurant">
        ...
        >
          <span class="flex pb-0.5">
            ...
            <span class="flex ml-2">{{ cart.getTotalItems }} Items</span></span
          ><span class="bg-white dark:bg-primary-dark rounded w-full py-2 px-2 text-green-500 dark:text-white mt-3"
        ...
        >
          <div class="sm:flex sm:space-x-4 items-center">
            ...
            <a
              target="_blank"
              :href="addressMap"
              class="hidden sm:flex space-x-2 items-center"
            >
