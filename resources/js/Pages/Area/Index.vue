         ...
         <table class="min-w-full border-collapse block md:table rounded-lg">
           <thead class="block md:table-header-group">
             <tr class="border border-grey-500 md:border-none block md:table-row absolute -top-full md:top-auto -left-full md:left-auto  md:relative ">
               <th class="bg-gray-600 p-2 text-slate-500 font-bold md:border md:border-grey-500 text-left block md:table-cell">ID</th>
               <th class="bg-gray-600 p-2 text-slate-500 font-bold md:border md:border-grey-500 text-left block md:table-cell">Area</th>
               <th class="bg-gray-600 p-2 text-slate-500 font-bold md:border md:border-grey-500 text-left block md:table-cell">Delivery Charge</th>
               <th class="bg-gray-600 p-2 text-slate-500 font-bold md:border md:border-grey-500 text-left block md:table-cell">Actions</th>
             </tr>
           </thead>
