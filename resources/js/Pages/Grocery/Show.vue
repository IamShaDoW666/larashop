...
<Head title="Products" />
  ...
  <div class="input-group relative flex rounded-md flex-between items-stretch gap-2 w-full md:w-1/2 px-8 md:px-8 mb-4"
                  >
                      <input
                          class="flex-auto dark:bg-primary-dark dark:text-white min-w-0 block rounded shadow-2xl w-full px-3 py-3 text-base mx-1 shadow-lg font-normal bg-white bg-clip-padding border-golden-yellow transition ease-in-out m-0 focus:bg-white focus:border-blue-600 focus:outline-none"
          ...
          <ProductsList :prod="prod" :filteredProducts="filteredProducts" :store="store" :toCart="toCart" :openModal="openModal"/>
