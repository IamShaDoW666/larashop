        ...
        >
            ...
            <div class="bg-blueGray-100 mt-4 px-6 pb-6">
                <form @submit.prevent="submit">
                    ...
                    <!-- </div> -->
                    <div
                        class="grid grid-cols-1 sm:grid-cols-2 gap-x-2 gap-y-2"
                    >
                        <div>
                        ...
                        <div>
                            <BreezeLabel for="available" value="Available?" />
                    ...
                    <div class="mt-4" v-if="product?.variants?.length">
                        <div class="flex justify-between">
                            ...
                            <button
                                ...
                                class="text-sm mt-4 px-2 py-1 sm:px-4 sm:py-2 bg-green-500 hover:bg-green-400 text-white font-bold rounded shadow"
                            >
                                Add Variant
                            </button>
                        </div>
                                    ...
                                    >
                                        ...
                                        <td>
                                            <button
                                                ...
                                                type="button"
                                                class="px-2 mr-2 py-0.5 rounded shadow bg-blue-400 hover:bg-blue-300 text-white font-bold text-sm"
                                            >
                                                Edit
                                            </button>
                                            <button
                                                ...
                                                "
                                                type="button"
                                                class="px-2 py-0.5 rounded shadow bg-red-400 hover:bg-red-300 text-white font-bold text-sm"
                                            >
                                                Delete
                                            </button>
                                        </td>
                    ...
                    <div v-else>
                        <button
                            type="button"
                            @click="variantOpen = !variantOpen"
                            class="text-sm mt-4 px-4 py-2 bg-green-500 hover:bg-green-400 text-white font-bold rounded shadow"
                        >
                            Add Variant
                        </button>
                    </div>
                    <div class="flex justify-end items-center gap-x-2">
                        <button
                            ...
                            type="button"
                            class="float-right bg-red-400 hover:bg-red-300 text-white font-bold px-4 py-2 rounded shadow"
                        >
                            Delete
                        </button>
                        <button
                            type="submit"
                            class="float-right bg-blue-400 hover:bg-blue-300 text-white font-bold px-4 py-2 rounded shadow"
                        >
                            Update
                        </button>
                    </div>
...
onMounted(() => {
    cat.value = props.categories.find(
        (category) => category.id == props.product.category_id
    );
});
...
const deleteProduct = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Inertia.delete(
                route("products.destroy", { product: props.product.id }),
                {
                    onSuccess: () => {
                        Swal.fire({
                            icon: "success",
