<template>
    <div
        @click="openModal"
        class="flex justify-between items-center mx-auto max-w-md sm:hidden z-50 hover:bg-green-300 shadow dark:bg-green-800 bg-green-400 rounded-lg w-full p-4 fixed mb-2 bottom-0 left-0 right-0"
    >
        <div class="font-bold dark:text-white">
            <i class="pr-2 fa-solid fa-cart-shopping dark:text-white"></i
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span
                                        class="active:opacity-50 transition-all duration-200 material-icons"
                                        >close</span
                                    >
                                </div>
                            </DialogTitle>
                            <div class="mt-4">
                                <div
                                    class="flex justify-between my-2 py-4 border-b border-gray-400 px-2 dark:text-white"
                                ...
                                >
                                    <div class="flex items-center gap-x-2">
                                        ...
                                        />
                                        <span
                                            class="font-semibold text-sm dark:text-white"
                                            >{{ item.name }}</span
                                        >
                                        <span
                            ...
                            <div class="flex items-center justify-between mx-4">
                                <div>
                                    <div class="flex text-sm gap-x-2 mb-2">
                                        ...
                                        <span
                                            :class="{
                                                'bg-green-400 dark:bg-golden-yellow dark:text-black text-white':
                                                    !cart.getTaxValue,
                                            }"
                                    ...
                                    <div
                                        ...
                                        class="flex text-sm gap-x-2 mb-2"
                                    >
                                        <span class="font-bold dark:text-white"
