                    ...
                    <div class="relative w-full mb-3">
                        ...
                        >
                            <div class="flex items-center">
                                <label
                                    class="mr-2 block uppercase text-blueGray-600 text-xs"
                                    for="Delivery"
                                    >Delivery</label
                                >
                                <input
                                    type="checkbox"
                                    v-model="form.can_deliver"
            ...
            <div class="flex flex-wrap">
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div
                            v-if="logoPreviewImage"
                            class="logoPreviewWrapper mb-3"
                            :style="{
                    ...
                    <div class="relative w-full mb-3">
                        ...
                        <div
                            v-if="previewImage"
                            class="bannerPreviewWrapper mb-3"
                            :style="{
