...
<ul class="md:flex-col md:min-w-full flex flex-col space-y-4 list-none">
  ...
  <li :class="{'text-black font-bold': route().current('guest.settings')}" class="items-center hover:text-gray-500">
    <div>
  ...
  <li :class="{'text-black font-bold': route().current('guest.index')}" class="items-center hover:text-gray-500">
    <div>
