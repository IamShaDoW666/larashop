<template>
  <div>
    ...
    >
      <!-- Guest -->
      <Link v-if="$page.props.auth.role == 'Guest'"
        :href="route('guest.settings')"
      ...
      <a
        ...
        class="text-sm hover:bg-gray-200 py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700"
      >
        Another action
      </a>
      <a
