<template>
    <TransitionRoot appear :show="planOpen" as="template">
  ...
  <!--
                      ...
                      <div>
                        <BreezeLabel for="price" value="Plan price" />
                      ...
                      <div>
                        <BreezeLabel for="price" value="Plan items" />
                        <input id="price" type="number" class="mt-2 border-gray-300 w-full sm:w-2/3 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" v-model="form.items" required>
                      </div>
